...
def search_markup2(
    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="6️⃣",
                callback_data=f"violet {ID6}|{duration6}|{user_id}",
            ),
            InlineKeyboardButton(
                text="7️⃣",
                callback_data=f"violet {ID7}|{duration7}|{user_id}",
            ),
            InlineKeyboardButton(
                text="8️⃣",
                callback_data=f"violet {ID8}|{duration8}|{user_id}",
            ),
        ],
        [
            InlineKeyboardButton(
                text="9️⃣",
                callback_data=f"violet {ID9}|{duration9}|{user_id}",
            ),
            InlineKeyboardButton(
                text="🔟",
                callback_data=f"violet {ID10}|{duration10}|{user_id}",
            ),
        ],
        [
            InlineKeyboardButton(
